...
export const PPU_STATE_SIZE = 0x4000 + 32 + 256 + 13 + 245760 + 61440 + 6;
  ...
  step(dots = 1): boolean {
    ...
    while (dots-- > 0) {
      ...
      const next = this.dot === 0 ? 1 : this.scanline < 240 && this.dot < 256 ? 256
        : mapperLine && this.dot < 280 ? 280 : 341;
