...
Full-system tests cover all 28 supported mappers with CHR ROM and CHR RAM,
...
The current mapper layer supports NROM (0), MMC1 (1), UxROM (2), CNROM (3), MMC3 bank switching (4), AxROM (7), MMC2 (9), MMC4 (10), Color Dreams (11), CPROM (13), mapper 15, Irem G-101 (32), BNROM (34), GxROM (66), Bandai 74161/7432 (70), Camerica (71), mapper 78, mapper 79, mapper 87, mapper 89, mapper 113, mapper 140, Bandai 74161/7432 with switchable mirroring (152), mapper 177, mapper 180, mapper 225, mapper 240, and mapper 241. MMC3 IRQ counting follows filtered PPU A12 rises; advanced mapper variants and revision-specific edge behavior remain in progress.
...
Its cartridge path accepts iNES 1.0 NROM, MMC1, UxROM, CNROM, MMC3, AxROM, MMC2, MMC4, Color Dreams, CPROM, mapper 15, Irem G-101, BNROM, GxROM, Bandai 74161/7432, Camerica, mapper 78, mapper 89, mapper 180, and mappers 79, 87, 113, 140, 152, 177, 225, 240 and 241 (mappers 0, 1, 2, 3, 4, 7, 9, 10, 11, 13, 15, 32, 34, 66, 70, 71, 78, 79, 87, 89, 113, 140, 152, 177, 180, 225, 240 and 241), including
