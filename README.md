...
Full-system tests cover all 17 supported mappers with CHR ROM and CHR RAM,
...
The current mapper layer supports NROM (0), MMC1 (1), UxROM (2), CNROM (3), MMC3 bank switching (4), AxROM (7), Color Dreams (11), mapper 15, BNROM (34), GxROM (66), mapper 79, mapper 87, mapper 113, mapper 140, mapper 177, mapper 225, and mapper 241. MMC3 IRQ counting follows filtered PPU A12 rises; advanced mapper variants and revision-specific edge behavior remain in progress.
...
Its cartridge path accepts iNES 1.0 NROM, MMC1, UxROM, CNROM, MMC3, AxROM, Color Dreams, BNROM, mapper 15, GxROM, and mappers 79, 87, 113, 140, 177, 225 and 241 (mappers 0, 1, 2, 3, 4, 7, 11, 15, 34, 66, 79, 87, 113, 140, 177, 225 and 241), including
