...
for (const mapper of [0, 1, 2, 3, 4, 7, 9, 10, 11, 13, 32, 34, 66, 70, 71, 78, 152, 180, 240]) test(`mapper ${mapper} battery bytes transfer between JS and fresh WASM instances`, async () => {
