...
export class Cartridge {
  ...
  get mirroring(): string {
    ...
    if (this.mapper == 78 || this.mapper == 89 || this.mapper == 152) return this.mirror ? 'single-upper' : 'single-lower';
  ...
  readCpu(address: i32, openBus: i32 = 0): i32 {
    ...
    let selected = this.mapper == 2 || this.mapper == 70 || this.mapper == 71 || this.mapper == 78 || this.mapper == 89 || this.mapper == 94 || this.mapper == 152
      ...
      : this.mapper == 11 || this.mapper == 34 || this.mapper == 38 || this.mapper == 66 || this.mapper == 7 || this.mapper == 79 || this.mapper == 113 || this.mapper == 140 || this.mapper == 177 || this.mapper == 241 ? ((this.mapper == 7 ? this.bank & 15 : this.mapper == 11 || this.mapper == 66 ? this.bank & 3 : this.mapper == 38 ? this.bank & 3 : this.mapper == 79 ? this.bank & 1 : this.bank) * 2 + ((address - 0x8000) >>> 14)) % this.prgBanks
  ...
  writeCpu(address: i32, value: i32, consecutive: boolean = false): void {
    ...
    if (this.mapper == 38 && address >= 0x7000 && address < 0x8000) { this.bank = value & 3; this.chrBank = (value >>> 2) & 3; return; }
  ...
  saveState(): Uint8Array {
    ...
    if (this.mapper == 11 || this.mapper == 32 || this.mapper == 34 || this.mapper == 38 || this.mapper == 66 || this.mapper == 70 || this.mapper == 71 || this.mapper == 78 || this.mapper == 79 || this.mapper == 89 || this.mapper == 94 || this.mapper == 113 || this.mapper == 140 || this.mapper == 152 || this.mapper == 177 || this.mapper == 180 || this.mapper == 240 || this.mapper == 241) out[7] = this.mapper == 32 ? this.highBank : this.bank;
    if (this.mapper == 225) out[7] = this.highBank;
    if (this.mapper == 38 || this.mapper == 66 || this.mapper == 70 || this.mapper == 78 || this.mapper == 79 || this.mapper == 89 || this.mapper == 113 || this.mapper == 140 || this.mapper == 152 || this.mapper == 225 || this.mapper == 240) out[8] = this.chrBank;
    ...
    if (this.mapper == 15 || this.mapper == 32 || this.mapper == 71 || this.mapper == 78 || this.mapper == 89 || this.mapper == 113 || this.mapper == 152 || this.mapper == 177 || this.mapper == 225 || this.mapper == 9 || this.mapper == 10) out[24] = this.mirror;
