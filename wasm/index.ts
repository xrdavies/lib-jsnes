...
let romLength: i32 = 0, pc: i32 = 0, cycles: i32 = 0, a: i32 = 0, x: i32 = 0, y: i32 = 0, sp: i32 = 0xfd, p: i32 = 0x24;
...
export function reset():void{RAM.fill(0);FRAME.fill(0xff000000);cycles=0;a=0;x=0;y=0;sp=0xfd;p=0x24;pc=romLength>=0x4000?read(0xfffc)|(read(0xfffd)<<8):0x8000;}
